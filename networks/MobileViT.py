...
class MobileViT(nn.Module):
    def __init__(self, image_size, dims, channels, num_classes, depths=[2, 4, 3], expansion=4, kernel_size=3,
        ...
        self.conv1 = conv_bn(8, channels[0], kernel_size=3, stride=patch_size)
        ...
        # self.fc = nn.Linear(1076480, num_classes, bias=False)
...
def mobilevit_xxs():
    ...
    return MobileViT(224, dims, channels, num_classes=1)
